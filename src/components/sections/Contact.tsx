      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-[80px_1.6fr_1fr] gap-12 md:gap-20">
        ...
        <div className="space-y-12">
          ...
          <form className="space-y-6 max-w-xl group">
            ...
            <button className="h-14 px-10 bg-black text-white font-black uppercase text-xs tracking-widest rounded-full hover:scale-105 active:scale-95 transition-all flex items-center gap-3 group/btn">
              Send Message
