...
import { MessageCircle, FileText, Settings, Rocket, User } from "lucide-react";
  ...
  return (
    <div className="flex flex-col items-center gap-2 group transition-all duration-300">
      ...
      <div
        ref={ref}
        className={cn(
          "z-10 flex size-9 md:size-10 lg:size-12 items-center justify-center rounded-full border-2 border-zinc-200 bg-white p-1 shadow-[0_0_20px_-12px_rgba(0,0,0,0.18)] transition-all duration-300 group-hover:scale-110 group-hover:border-zinc-300 group-hover:shadow-[0_0_30px_-5px_rgba(0,0,0,0.12)]",
          className,
        )}>
        {children}
      </div>
      {label && labelPosition === "bottom" && (
        <span className="text-[8px] md:text-[10px] font-black text-zinc-500 uppercase tracking-widest text-center max-w-[80px] md:max-w-[100px]">
          {label}
        </span>
      )}
    </div>
...
const Process = () => {
  ...
  return (
    <section
      id="process"
      className="relative w-full bg-white border-t border-zinc-200 px-6 md:px-16 py-24 pb-32 overflow-hidden">
      <div className="max-w-7xl mx-auto space-y-24">
        ...
        {/* BEAM CONTAINER */}
        <div
          className="relative flex min-h-[400px] md:min-h-[500px] lg:min-h-[600px] w-full items-center justify-center rounded-3xl border border-zinc-200 bg-zinc-50/80 p-4 md:p-10 lg:p-20"
          ref={containerRef}>
          {/* DIAMOND GRID LAYOUT */}
          <div className="flex flex-col md:flex-row items-center justify-center gap-10 md:gap-4 lg:gap-14 w-full">
            ...
            <div className="flex flex-row md:flex-col gap-12 md:gap-24">
              <Circle
                ...
                <svg
                  ...
                  className="w-full h-full fill-zinc-900">
            ...
            <div className="flex flex-row md:flex-col gap-12 md:gap-24">
              <Circle
                ...
                <img
                  src="/visual-studio-code-icon.svg"
            ...
            <div className="md:mt-0">
              <Circle ref={devRef} label="Development Phase">
                <Rocket className="text-zinc-900 group-hover:text-zinc-700" />
              </Circle>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 pt-10 border-t border-zinc-200 opacity-80">
          <div className="space-y-2">
            <p className="text-zinc-900 font-bold uppercase text-[10px] tracking-widest flex items-center gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-zinc-300" />
              I. Research
            </p>
            <p className="text-zinc-600 text-[10px] leading-relaxed uppercase tracking-wider">
